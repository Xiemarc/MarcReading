...
public class ScreenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * UIUtils.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / UIUtils.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue /UIUtils.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue *UIUtils.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    private int getStatusBarHeight() {
        ...
        try {
            ...
            sbar = UIUtils.getContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
