...
import com.xiemarc.marcreading.utils.DeviceUtils;
...
/**
 * des:Retrofit2 Cookie拦截器。用于保存和设置Cookies
 * author: marc
 * date:  2016/11/14 21:46
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (original.url().toString().contains("book/") ||
            ...
            Request request = original.newBuilder()
                    ...
                    .addHeader("X-Device-Id", DeviceUtils.getIMEI(UIUtils.getContext()))
