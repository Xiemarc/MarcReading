package com.marc.marclibs.blur;
...
public class BlurredView extends RelativeLayout{
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.gallery_BlurredView);
        Drawable drawable = typedArray.getDrawable(R.styleable.gallery_BlurredView_gallery_src);
        isMove = typedArray.getBoolean(R.styleable.gallery_BlurredView_gallery_move, false);
        isDisableBlurred = typedArray.getBoolean(R.styleable.gallery_BlurredView_gallery_disableBlurred, false);
