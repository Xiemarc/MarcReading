 ...
 */
package com.marc.marclibs.loading;
...
public class VaryViewHelperController {
    ...
    public void showNetworkError(View.OnClickListener onClickListener) {
        ...
        textView.setText(helper.getContext().getResources().getString(R.string.gallery_common_no_network_msg));
    ...
    public void showError(String errorMsg, View.OnClickListener onClickListener) {
        ...
        if (!CommonUtils.isEmpty(errorMsg)) {
            ...
            textView.setText(helper.getContext().getResources().getString(R.string.gallery_common_error_msg));
        }
    ...
    public void showEmpty(String emptyMsg, View.OnClickListener onClickListener) {
        ...
        if (!CommonUtils.isEmpty(emptyMsg)) {
            ...
            textView.setText(helper.getContext().getResources().getString(R.string.gallery_common_empty_msg));
        }
    ...
    public void showLoading(String msg) {
        View layout = helper.inflate(R.layout.gallery_loading_heler);
        ImageView iv = (ImageView) layout.findViewById(R.id.loadingIv);
